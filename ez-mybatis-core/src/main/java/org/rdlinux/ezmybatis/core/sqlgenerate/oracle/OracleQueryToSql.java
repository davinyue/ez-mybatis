...
import org.rdlinux.ezmybatis.core.sqlgenerate.QueryToSql;
...
public class OracleQueryToSql implements QueryToSql {
    @Override
    ...
    public StringBuilder limitToSql(StringBuilder sql, EzLimit limit) {
        return new StringBuilder();
    }

    public String orderByToSql(Configuration configuration, EzOrder order) {
    ...
    public String groupByToSql(Configuration configuration, EzGroup group) {
    ...
    public String whereToSql(Configuration configuration, EzWhere where, MybatisParamHolder mybatisParamHolder) {
        if (where == null) {
            return "";
        }
    ...
    public String joinsToSql(Configuration configuration, List<EzJoin> joins, MybatisParamHolder mybatisParamHolder) {
    ...
    public String joinToSql(Configuration configuration, EzJoin join, MybatisParamHolder mybatisParamHolder) {
        if (join == null) {
            return "";
        }
    ...
    public String conditionsToSql(Configuration configuration, List<EzCondition> conditions,
    ...
    public String conditionToSql(Configuration configuration, EzCondition condition,
                                 MybatisParamHolder mybatisParamHolder) {
        if (condition == null) {
            return "";
        }
