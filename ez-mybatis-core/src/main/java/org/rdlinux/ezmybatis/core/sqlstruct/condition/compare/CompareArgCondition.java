 ...
 */
@Getter
public abstract class CompareArgCondition implements Condition, SqlStruct {
    ...
    public CompareArgCondition(LogicalOperator logicalOperator, Operator operator, Arg value) {
    ...
    public CompareArgCondition(LogicalOperator logicalOperator, Operator operator) {
        Assert.notNull(logicalOperator, "logicalOperator can not be null");
        Assert.notNull(operator, "operator can not be null");
    ...
    public CompareArgCondition(LogicalOperator logicalOperator, Operator operator, Arg minValue, Arg maxValue) {
        Assert.notNull(logicalOperator, "logicalOperator can not be null");
        Assert.notNull(operator, "operator can not be null");
    ...
    public CompareArgCondition(LogicalOperator logicalOperator, Operator operator, List<Arg> values) {
        Assert.notNull(logicalOperator, "logicalOperator can not be null");
        Assert.notNull(operator, "operator can not be null");
