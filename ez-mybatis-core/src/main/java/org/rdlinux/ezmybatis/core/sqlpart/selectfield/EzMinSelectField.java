...
public class EzMinSelectField extends EzNormalSelectField {
    public EzMinSelectField(EzTable table, String field) {
        super(table, field);
    }

    public EzMinSelectField(EzTable table, String field, String alias) {
