...
public class EzMaxSelectField extends EzNormalSelectField {
    public EzMaxSelectField(EzTable table, String field) {
        super(table, field);
    }

    public EzMaxSelectField(EzTable table, String field, String alias) {
