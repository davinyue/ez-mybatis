...
#### 首先我们需要像使用原生的mybatis一样，配置mybatis-config.xml文件 <a id="shou-xian-wo-men-xu-yao-xiang-shi-yong-yuan-sheng-de-mybatis-yi-yang-pei-zhi-mybatisconfigxml-wen-jian"></a>
...
```text
<setting name="universalCrudScan" 
    value="org.linuxprobe.demo.model,org.linuxprobe.demo2.model">
</setting>
```
...
#获取sqlSession，通过sqlSesssion对数据库进行操作
