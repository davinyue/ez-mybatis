...
import org.rdlinux.oracle.OracleBaseTest;
...
public class PgSqlUpdateTest extends PgSqlBaseTest {
    ...
    public void mergeNotMatchedInsertTest() {
        ...
        SqlSession prepareSession = OracleBaseTest.sqlSessionFactory.openSession();
        try {
            JdbcInsertDao jdbcInsertDao = new JdbcInsertDao(prepareSession);
