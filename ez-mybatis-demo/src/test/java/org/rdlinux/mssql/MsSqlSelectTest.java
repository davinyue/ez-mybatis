...
import org.rdlinux.pg.PgBaseTest;
...
public class MsSqlSelectTest extends MsSqlBaseTest {
    ...
    public void userSelectBySql() {
        List<User> users = this.sqlSession.getMapper(UserMapper.class).selectBySql("SELECT top 2 * FROM ez_user", new HashMap<>());
        Assert.assertNotNull(users);
    ...
    public void ezSelectOneMapBySql() {
        Map<String, Object> map = this.sqlSession.getMapper(EzMapper.class).selectOneMapBySql("SELECT top 1 * FROM ez_user", new HashMap<>());
    ...
    public void ezSelectMapBySql() {
        List<Map<String, Object>> maps = this.sqlSession.getMapper(EzMapper.class).selectMapBySql("SELECT top 2 * FROM ez_user", new HashMap<>());
    ...
    public void ezSelectOneObjectBySql() {
        User user = this.sqlSession.getMapper(EzMapper.class).selectOneObjectBySql(User.class, "SELECT top 1 * FROM ez_user", new HashMap<>());
        Assert.assertNotNull(user);
    ...
    public void ezSelectObjectBySql() {
        List<User> users = this.sqlSession.getMapper(EzMapper.class).selectObjectBySql(User.class, "SELECT top 2 * FROM ez_user", new HashMap<>());
        Assert.assertNotNull(users);
