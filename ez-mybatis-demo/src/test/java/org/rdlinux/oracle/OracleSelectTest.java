...
public class OracleSelectTest extends OracleBaseTest {
    ...
    private String getOneUserId(SqlSession sqlSession) {
        ...
        User user = mapper.selectOneObjectBySql(User.class, "SELECT * FROM ez_user where rownum = 1", new HashMap<>());
    ...
    private List<String> getUserIds(SqlSession sqlSession, int limit) {
        EzMapper mapper = sqlSession.getMapper(EzMapper.class);
        List<User> users = mapper.selectObjectBySql(User.class, "SELECT * FROM ez_user where rownum < " + limit, new HashMap<>());
    ...
    public void userSelectBySql() {
        SqlSession sqlSession = OracleBaseTest.sqlSessionFactory.openSession();
        this.ensureData(sqlSession);
        List<User> users = sqlSession.getMapper(UserMapper.class).selectBySql("SELECT * FROM ez_user where rownum < 3", new HashMap<>());
    ...
    public void ezSelectOneMapBySql() {
        SqlSession sqlSession = OracleBaseTest.sqlSessionFactory.openSession();
        this.ensureData(sqlSession);
        Map<String, Object> map = sqlSession.getMapper(EzMapper.class).selectOneMapBySql("SELECT * FROM ez_user where rownum = 1", new HashMap<>());
    ...
    public void ezSelectMapBySql() {
        SqlSession sqlSession = OracleBaseTest.sqlSessionFactory.openSession();
        this.ensureData(sqlSession);
        List<Map<String, Object>> maps = sqlSession.getMapper(EzMapper.class).selectMapBySql("SELECT * FROM ez_user where rownum < 3", new HashMap<>());
    ...
    public void ezSelectOneObjectBySql() {
        SqlSession sqlSession = OracleBaseTest.sqlSessionFactory.openSession();
        this.ensureData(sqlSession);
        User user = sqlSession.getMapper(EzMapper.class).selectOneObjectBySql(User.class, "SELECT * FROM ez_user where rownum = 1", new HashMap<>());
    ...
    public void ezSelectObjectBySql() {
        SqlSession sqlSession = OracleBaseTest.sqlSessionFactory.openSession();
        this.ensureData(sqlSession);
        List<User> users = sqlSession.getMapper(EzMapper.class).selectObjectBySql(User.class, "SELECT * FROM ez_user where rownum < 3", new HashMap<>());
    ...
    public void ezQueryConcurrentSelectRetTypeTest() throws InterruptedException, java.util.concurrent.ExecutionException {
        this.ensureData(OracleBaseTest.sqlSessionFactory.openSession());
