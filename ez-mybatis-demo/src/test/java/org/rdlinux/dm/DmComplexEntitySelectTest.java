...
public class DmComplexEntitySelectTest extends DmBaseTest {
    ...
    public void ezQueryCaseWhen() {
        ...
        CaseWhen ageGroup = CaseWhen.build(c ->
                c.when(w -> w.add(table.field(ComplexUser.Fields.age).lt(19)), "Young")
        ...
        EzQuery<ComplexUser> query = EzQuery.builder(ComplexUser.class).from(userTable)
                ...
                .where(w -> w
                        .addGroup(g -> g
                                ...
                                .add(userTable.field(ComplexUser.Fields.username).orEq("TestUser3")))
