...
import org.rdlinux.mysql.MySqlBaseTest;
...
public class DmSelectTest extends DmBaseTest {
    ...
    public void userSelectBySql() {
        List<User> users = this.sqlSession.getMapper(UserMapper.class).selectBySql("SELECT * FROM ez_user WHERE ROWNUM <= 2", new HashMap<>());
        Assert.assertNotNull(users);
    ...
    public void ezSelectOneMapBySql() {
        Map<String, Object> map = this.sqlSession.getMapper(EzMapper.class).selectOneMapBySql("SELECT * FROM ez_user WHERE ROWNUM <= 1", new HashMap<>());
    ...
    public void ezSelectMapBySql() {
        List<Map<String, Object>> maps = this.sqlSession.getMapper(EzMapper.class).selectMapBySql("SELECT * FROM ez_user WHERE ROWNUM <= 2", new HashMap<>());
    ...
    public void ezSelectOneObjectBySql() {
        User user = this.sqlSession.getMapper(EzMapper.class).selectOneObjectBySql(User.class, "SELECT * FROM ez_user WHERE ROWNUM <= 1", new HashMap<>());
        Assert.assertNotNull(user);
    ...
    public void ezSelectObjectBySql() {
        List<User> users = this.sqlSession.getMapper(EzMapper.class).selectObjectBySql(User.class, "SELECT * FROM ez_user WHERE ROWNUM <= 2", new HashMap<>());
        Assert.assertNotNull(users);
