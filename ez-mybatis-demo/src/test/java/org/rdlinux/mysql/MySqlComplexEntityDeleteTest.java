...
@Slf4j
public class MySqlComplexEntityDeleteTest extends MySqlBaseTest {
    ...
    public void ezDeleteLambdaDsl() {
        ...
        ComplexOrderItem orderItem = new ComplexOrderItem();
        orderItem.setOrderId(order.getId());
        orderItem.setProductId("PROD-DEL");
        orderItem.setQuantity(2);
        this.sqlSession.getMapper(EzMapper.class).insert(orderItem);
        this.sqlSession.commit();
